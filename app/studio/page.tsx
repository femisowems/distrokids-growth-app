    ...
    <section className="mx-auto max-w-7xl px-5 py-10 lg:px-8">
      <div className="max-w-3xl">
        ...
        <h1 className="mt-4 text-5xl font-medium tracking-[-0.05em] text-white md:text-6xl">
          Launch campaigns with AI, structure, and taste.
        </h1>
        <p className="mt-5 max-w-2xl text-lg leading-8 text-white/66">
          Compose a release brief, preview the rollout, and coordinate launch
          assets across artists, campaigns, experiments, and landing pages.
        </p>
      </div>
          ...
          <Card className="glass">
            ...
            <CardBody className="space-y-3">
              {releases.map((release) => (
                <div
                  key={release.id}
                  className="flex items-center justify-between rounded-2xl border border-white/8 bg-white/5 p-4"
                >
                  <div>
