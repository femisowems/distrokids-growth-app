...
const analyticsHighlights = [
  ...
  { label: "Retention", value: "68%", detail: "7-day fan return rate" },
  {
    label: "Attribution",
    value: "94%",
    detail: "Tracked sessions with source",
  },
...
const funnels = [
  ...
  { step: "Landing Page", visits: 31220, color: "from-neon-500 to-accent-400" },
  {
    step: "Email Capture",
    visits: 18450,
    color: "from-accent-500 to-neon-400",
  },
  {
    step: "Spotify Pre-Save",
    visits: 12780,
    ...
    <div className="overflow-hidden">
      <section className="relative mx-auto max-w-7xl px-5 py-10 lg:px-8 lg:py-16">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
          <motion.div {...motionCard}>
            <Badge className="mb-5 border-neon-400/30 bg-neon-400/10 text-neon-400">
            ...
            <p className="mt-6 max-w-2xl text-pretty text-lg leading-8 text-white/68 md:text-xl">
              Build landing pages, experiment with conversion systems,
              orchestrate AI marketing, and read the full story of a release
              from first click to retained fan.
            </p>
          ...
          <motion.div
            id="launch-preview"
            {...motionCard}
            transition={{ ...motionCard.transition, delay: 0.1 }}
          >
            <Card className="relative overflow-hidden border-white/10 bg-[#0a1324]/90 shadow-glow">
              ...
              <CardBody className="relative space-y-6 p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="rounded-full border border-neon-400/20 bg-neon-400/10 px-3 py-1 text-xs text-neon-400">
                    3 days to drop
                  </div>
                </div>
                  ...
                  {landingThemes.map((theme) => (
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          background: `linear-gradient(135deg, ${theme.surface}, rgba(255,255,255,0.04))`,
      ...
      <section className="mx-auto max-w-7xl px-5 py-8 lg:px-8">
        <div className="grid gap-5 lg:grid-cols-5">
          <Card className="glass lg:col-span-3">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Flame className="h-4 w-4 text-sunset-400" /> Acquisition funnel
              </CardTitle>
              <CardDescription>
                Track traffic from ad impression through to fan retention.
              </CardDescription>
            </CardHeader>
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                <Card className="border-white/8 bg-white/5">
                  <CardBody className="p-4">
                    ...
                    <div className="mt-2 text-2xl">48.2k</div>
                  </CardBody>
                </Card>
                <Card className="border-white/8 bg-white/5">
                  <CardBody className="p-4">
                    <div className="text-xs text-white/40">Dropoff</div>
                    <div className="mt-2 text-2xl">18.9%</div>
                  </CardBody>
                </Card>
                <Card className="border-white/8 bg-white/5">
                  <CardBody className="p-4">
                    <div className="text-xs text-white/40">Conversions</div>
                    <div className="mt-2 text-2xl">12.7%</div>
                  </CardBody>
                </Card>
              </div>
            </CardBody>
          ...
          <Card className="glass lg:col-span-2">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Target className="h-4 w-4 text-neon-400" /> Experiment engine
              </CardTitle>
            ...
            <CardBody className="space-y-4">
              <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
                ...
                <div className="mt-1 text-sm text-white/56">
                  {winner.conversions} conversions
                </div>
              </div>
                ...
                >
                  ...
                  <div className="mt-3 h-2 rounded-full bg-white/6">
                    <div
                      ...
                      style={{
                        width: `${conversionRate(variant.conversions, 1000)}%`,
                      }}
                    />
                  </div>
                </div>
      ...
      <section className="mx-auto grid max-w-7xl gap-5 px-5 py-8 lg:grid-cols-3 lg:px-8">
        <Card className="glass lg:col-span-2">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Wand2 className="h-4 w-4 text-sunset-400" /> AI marketing
              workflows
            </CardTitle>
            <CardDescription>
              Prompt playground outputs for captions, hooks, emails, and SEO
              blocks.
            </CardDescription>
          </CardHeader>
          <CardBody className="grid gap-4 md:grid-cols-2">
            {aiGenerations.map((item) => (
              ...
              >
                ...
                <div className="mt-4 rounded-2xl border border-white/8 bg-white/5 p-4 text-sm leading-6 text-white/84">
                  {item.output}
                </div>
              </div>
            ))}
        ...
        <Card className="glass">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <LineChart className="h-4 w-4 text-neon-400" /> Analytics snapshot
            </CardTitle>
            <CardDescription>
              Attribution and retention at a glance.
            </CardDescription>
          </CardHeader>
          <CardBody className="space-y-4">
            ...
            <Button
              variant="ghost"
              className="w-full justify-between rounded-2xl border border-white/10 bg-white/5 px-4 py-3"
            >
      ...
      <section className="mx-auto max-w-7xl px-5 py-8 lg:px-8">
        <Card className="glass overflow-hidden">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Sparkles className="h-4 w-4 text-neon-400" /> Launch surfaces
            </CardTitle>
            <CardDescription>
              Landing pages, SEO, attribution, and internal marketing CMS
              connected in one OS.
            </CardDescription>
          </CardHeader>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-white/40">
                        {
                          artists.find(
                            (artist) => artist.id === release.artistId,
                          )?.name
                        }
                      </div>
                    ...
                    <div className="rounded-full border border-white/10 px-3 py-1 text-xs uppercase tracking-[0.28em] text-white/54">
                      {release.status}
                    </div>
                  </div>
                  <div className="mt-4 grid gap-3 sm:grid-cols-3">
                    <div className="rounded-2xl border border-white/8 bg-white/5 p-3">
                      <div className="text-xs text-white/38">Release date</div>
                    ...
                    <div className="rounded-2xl border border-white/8 bg-white/5 p-3">
                      <div className="text-xs text-white/38">Pre-saves</div>
                      <div className="mt-2 text-sm text-white">
                        {release.preSaves.toLocaleString()}
                      </div>
                    </div>
                    <div className="rounded-2xl border border-white/8 bg-white/5 p-3">
                      <div className="text-xs text-white/38">Campaigns</div>
                      <div className="mt-2 text-sm text-white">
                        {
                          campaigns.filter(
                            (campaign) => campaign.releaseId === release.id,
                          ).length
                        }
                      </div>
                    </div>
              ...
              <Card className="border-white/8 bg-white/5">
                <CardBody className="p-5">
                  ...
                  <div className="mt-2 text-2xl text-white">
                    Campaign scheduling and asset uploads
                  </div>
                  <div className="mt-2 text-sm text-white/54">
                    Editorial interface with drag-and-drop sections, AI asset
                    generation, and release-ready previews.
                  </div>
                </CardBody>
              </Card>
              <Card className="border-white/8 bg-white/5">
                <CardBody className="p-5">
                  ...
                  <div className="mt-2 text-2xl text-white">
                    Programmatic release pages
                  </div>
                  <div className="mt-2 text-sm text-white/54">
                    SSR metadata, schema markup, OG generation, and a dynamic
                    sitemap for artists and releases.
                  </div>
                </CardBody>
              </Card>
              <Button asChild variant="accent" size="lg">
                <Link href="/studio">
                  <Play className="h-4 w-4" /> Open growth studio
                </Link>
              </Button>
            </div>
          </CardBody>
