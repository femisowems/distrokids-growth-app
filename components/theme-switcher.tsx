  ...
  return (
    <div className="flex items-center gap-2">
      {THEMES.map((t) => (
        ...
        >
          <span
            className={`block h-full w-full rounded-sm ${t === "default" ? "bg-gradient-to-br from-cyan-300 via-violet-400 to-rose-400" : ""} ${t === "sunset" ? "bg-black" : ""} ${t === "pastel" ? "bg-white border border-white/20" : ""}`}
          />
        </button>
      ))}
    </div>
